...
| Model | Label | Learning | Decision | Free parameters | Nests within |
|---|---|---|---|---|---|
| $\mathcal{M}_0$ | Original (BAY) | Binary / graded | Monte Carlo | $k_{conf}$ | $\mathcal{M}_\lambda$, $\mathcal{M}_\eta$, $\mathcal{M}_{\eta\lambda}$ |
| $\mathcal{M}_\lambda$ | Uncertainty-averse | Binary / graded | Mean–variance | $k_{conf}, \lambda$ | $\mathcal{M}_{\eta\lambda}$ |
| $\mathcal{M}_\eta$ | Cue-integration | $\eta$-blended | Monte Carlo | $k_{conf}, \eta$ | $\mathcal{M}_{\eta\lambda}$ |
| $\mathcal{M}_{\eta\lambda}$ | Combined | $\eta$-blended | Mean–variance | $k_{conf}, \eta, \lambda$ | — |
...
|---|---|---|---|---|
| $\mathcal{M}_0$ (Original) | 1 | 17.31 | 38.03 | **17** |
| $\mathcal{M}_\lambda$ (Uncertainty-averse) | 2 | 15.74 | 38.28 | **12** |
| $\mathcal{M}_\eta$ (Cue-integration) | 2 | 17.10 | 41.00 | 0 |
| $\mathcal{M}_{\eta\lambda}$ (Combined) | 3 | 15.76 | 41.72 | 0 |
